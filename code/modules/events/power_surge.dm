...
/datum/event/power_surge/announce()
	command_announcement.Announce("Энергетические показатели указывают на незначительный сдвиг в кристаллической гиперструктуре двигателя. Рекомендуется более тщательный контроль стабильности кристалла и выходной мощности.", "Системы Внутренней Безопасности ЭКСО [location_name()]", zlevels = affecting_z)
...
/datum/event/power_surge/end()
	for (var/obj/machinery/power/supermatter/S in SSmachines.machinery)
		...
		command_announcement.Announce("Сдвиг кристаллической гиперструктуры двигателя рассеялся. Благодарим за ваше терпение.", "Системы Внутренней Безопасности ЭКСО [location_name()]", zlevels = affecting_z)
