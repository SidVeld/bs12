/datum/map/torch
	lobby_screens = list('maps/torch/lobby/proxima.gif', 'maps/torch/lobby/bobot.gif', 'maps/torch/lobby/unknown.gif', 'maps/torch/lobby/pioneers.gif', 'maps/torch/lobby/city.jpg')
	lobby_tracks = list(
